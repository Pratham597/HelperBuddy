...
const IMAGE_URL ="https://scrubnbubbles.com/wp-content/uploads/2022/05/cleaning-service.jpeg";
const Heading = "Manage HelperBuddy with Ease!";
const SubHeading = "Admin access for monitoring, analytics, and service management.";
...
export default function Page() {
    ...
    return (
        <div className="flex h-screen">
            ...
            >
                <LoginPageImage IMAGE_URL={IMAGE_URL} Heading={Heading} SubHeading={SubHeading} />
            </div>

            {/* Form Section */}
            <div className="flex flex-col items-center justify-center w-full md:w-1/2 p-8">
                {isLogin ? (
                    <LoginForm isLogin={isLogin} setIsLogin={setIsLogin} isAdmin={isAdmin} />
                ) : (
