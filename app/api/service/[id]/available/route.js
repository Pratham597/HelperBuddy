...
export const GET= async (req,{params}) => { 
    ...
    const count=await PartnerService.countDocuments({service:id,pincode:{$in:[pincode]}});
    if(count==0) return NextResponse.json({error:"Service not available in this area"}, {status:404});
