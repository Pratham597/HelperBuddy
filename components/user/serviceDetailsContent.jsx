    ...
    >
      <div className="relative w-full max-w-6xl">
        <Button
          variant="outline"
          onClick={onClose}
          className="absolute my-5 -mx-3 -top-10 right-0 text-white bg-red-600 hover:bg-red-700 border-none p-1 rounded-full w-8 h-8 flex items-center justify-center shadow-md z-10"
        >
          ✖
        </Button>
        {!service ? (
